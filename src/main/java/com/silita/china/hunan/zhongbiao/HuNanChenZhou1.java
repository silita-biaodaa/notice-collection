 ...
 * 郴州市 郴州市公共资源交易中心  http://www.czggzy.net/jyxx/004001/004001003/1.html
 */
...
@Component
@JobHander(value = "HuNanChenZhou1")
public class HuNanChenZhou1 extends BaseSnatch{
    ...
    public void sntachTask() throws Exception{
        int page = 1;
        String url = "http://www.czggzy.net/jyxx/004001/004001003/1.html";
        super.queryBeforeSnatchState(url);
        try {
        for(int i=1;i<=page;i++) {
            if (i > 1) {
                url = "http://www.czggzy.net/jyxx/004001/004001003/" + i + ".html";
            }
            ...
            url = "http://www.czggzy.net/jyxx/004001/004001003/1.html";
