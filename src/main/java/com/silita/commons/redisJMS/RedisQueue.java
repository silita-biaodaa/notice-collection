...
public class RedisQueue<T> implements DisposableBean {
    ...
    private BoundListOperations<String, Notice> listOperations;//noblocking
...
//    public RedisQueue(RedisTemplate redisTemplate,RedisQueueListener listener,String key){
//        this.listener=listener;
//        this.key=key;
//        this.redisTemplate=redisTemplate;
//
...
//    }
     ...
     * 从队列的头，插入
     */
    public void pushFromHead(Notice value){
        listOperations.leftPush(value);
    }

    public void pushFromTail(Notice value){
     ...
     */
    public Notice removeFromHead(){
        return listOperations.leftPop();
    }

    public Notice removeFromTail(){
